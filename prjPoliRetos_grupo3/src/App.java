...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        CadenaCaracteres cadCar = new CadenaCaracteres();
        SeccionArrays secArr = new SeccionArrays();
        LoadingDelay loadDel = new LoadingDelay();
        Recursion rec = new Recursion();
        GrafosYAutomatas grfAuto = new GrafosYAutomatas();
        SeriesNumericas serNum = new SeriesNumericas();
